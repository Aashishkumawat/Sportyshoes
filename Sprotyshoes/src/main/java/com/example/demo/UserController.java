...
//		 return "registration is successfully done";
	...
	private String FOLDER="C:\\image\\"; 
	@RequestMapping("/insert")
	public ModelAndView insert(HttpServletRequest request,HttpServletResponse response,@RequestParam("pname") String pname,@RequestParam("cost") String pcost,@RequestParam("file") MultipartFile file) {
		ModelAndView mv=new ModelAndView();
